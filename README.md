...
- A Middleware as it regards Express, is a piece of function that sits between the start and the completion on a request-response journey to offer more robust capabilities.

- [x] Describe a Resource?

- A resource is piece of intormation that can be transferred between a server and client.

- [x] What can the API return to help clients know if a request was successful?

- Status codes of 200(OK) or 201(Created) with a valid json Object such as in `res.status(200).json('something')`

- [x] How can we partition our application into sub-applications?

- By using Express Router in each of the specified directories
